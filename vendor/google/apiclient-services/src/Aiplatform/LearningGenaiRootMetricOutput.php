...
class LearningGenaiRootMetricOutput extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(LearningGenaiRootMetricOutput::class, 'Google_Service_Aiplatform_LearningGenaiRootMetricOutput');
